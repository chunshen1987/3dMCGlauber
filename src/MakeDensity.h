...
class MakeDensity {
  ...
  public:
    ...
    void set_2D_grid_info(
        int gridNx, double gridDx, int gridNy, double gridDy) {
        gridNx_ = gridNx;
        gridDx_ = gridDx;
        gridXSize_ = gridNx_ * gridDx_;
        gridNy_ = gridNy;
    ...
    void set_2D_grid_info_etax(
        int gridNeta, double gridDeta, int gridNx, double gridDx) {
        gridNeta_ = gridNeta;
        gridDeta_ = gridDeta;
        gridEtaSize_ = gridNeta_ * gridDeta_;
        gridNx_ = gridNx;
    ...
    void set_3D_grid_info(
        int gridNx, double gridDx, int gridNy, double gridDy, int gridNeta,
        double gridDeta) {
        gridNx_ = gridNx;
        gridDx_ = gridDx;
        gridXSize_ = gridNx_ * gridDx_;
    ...
    void output_eccentricity(
        std::string filenameHeader, const int eventId,
        const int outputMode = 0) const;
